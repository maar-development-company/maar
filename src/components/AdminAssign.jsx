...
export const AdminAssign = () => {
  ...
  const getHouseholdList = async () => {
    ...
    try {
      ...
      const stringData2 = municipalityObj.groupNumArray;
      console.log(stringData, stringData2);
      const parsedArray = JSON.parse(stringData);
      const parsedArray2 = JSON.parse(stringData2);
      console.log(":", householdArray);
      console.log(parsedArray, parsedArray2);
