...
router.post("/maar/login", async (req, res) => {
	...
	const postDataCheckFunc = async () => {
		...
		if (postData.loginCategory === 1) {
			...
			if (MailAdressIDResult.length !== 0) {
				const resultObj = {
					judge: role,
